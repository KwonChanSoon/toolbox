 ...
 * See: http://highstick.blogspot.com/2011/11/howto-categorize-junit-test-methods-and.html?m=1
 */
public class FlexibleCategories extends Suite {
  ...
  /**
   * Specifies an annotation for methods which must be present in a matching class (e.g.
   * 
   * @TestMethodAnnotationFilter(Test.class)).
