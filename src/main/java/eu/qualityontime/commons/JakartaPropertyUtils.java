...
import eu.qualityontime.AppObjects;

@SuppressWarnings("rawtypes")
public class JakartaPropertyUtils {
  ...
  public static Map<String, Object> describe(Object bean) {
    try {
      return AppObjects.cast(PropertyUtils.describe(bean));
    } catch (Exception e) {
      throw new RuntimeException(e);
    }
  }
  ...
  public static <T> T getProperty(Object bean, String name, Class<T> clazz) {
    try {
      return AppObjects.cast(PropertyUtils.getProperty(bean, name));
    } catch (NestedNullException e) {
      return null;
    } catch (Exception e) {
      throw new RuntimeException(e);
